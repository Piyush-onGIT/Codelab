...
void solve() {
    ...
    if (a == 0 and c == 0) { cout << 0 line; return; }
    if (a == 0 or c == 0) { cout << 1 line; return; }
    ...
    if (a == c and b == d) cout << 0 line;
    else {
	    if ((a * d) % (b * c) == 0 or (b * c) % (a * d) == 0) cout << 1 line;
	    else cout << 2 line;
	}
}
