...
void solve() {
	// Problem: Select a subsequence where no two adjacent element is selected
	// and it should give the maximum sum possible
    ll a[5] = {1, 2, 4, -1, 10};

    // dp[i] is the state and stores the sum till ith index
    // making sure that no two adjancent element is selected
    ll dp[5] = {1, 2};

    loop(i, 2, 5) {
    	// below is the transition equation
